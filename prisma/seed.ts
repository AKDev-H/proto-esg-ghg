import { PrismaClient, EmissionScope, Scope3Category, Country } from "@prisma/client";
...
async function main() {
  ...
  const factorSources = [
    { name: "EPA", abbreviation: "EPA", description: "US Environmental Protection Agency" },
    { name: "DEFRA", abbreviation: "DEFRA", description: "UK Department for Environment, Food & Rural Affairs" },
    { name: "Malaysia Grid", abbreviation: "MY-GRID", description: " Malaysia Grid Emission Factor" },
  ];
